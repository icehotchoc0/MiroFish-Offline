  ...
  <div class="home-container">
    ...
    <nav class="navbar" :style="s.navbar">
      ...
      <div class="nav-links" :style="s.navLinks">
        <router-link to="/personas" :style="s.personaLink">페르소나 라이브러리</router-link>
...
const s = reactive({
  ...
  personaLink: { color: '#fff', textDecoration: 'none', fontFamily: mono, fontSize: '0.9rem', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '8px', borderRight: '1px solid #444', paddingRight: '16px' },
