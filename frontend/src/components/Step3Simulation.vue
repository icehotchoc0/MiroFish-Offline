  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          ...
          <div class="platform-stats">
            ...
            <span class="stat">
              <span class="stat-label">행동</span>
              <span class="stat-value mono">{{ runStatus.twitter_actions_count || 0 }}</span>
            </span>
          </div>
          <!-- Available Actions Tooltip -->
          <div class="actions-tooltip">
            <div class="tooltip-title">사용 가능한 행동</div>
        ...
        <div class="platform-status reddit" :class="{ active: runStatus.reddit_running, completed: runStatus.reddit_completed }">
          <div class="platform-header">
            ...
            <span class="platform-name">주제 커뮤니티</span>
          ...
          <div class="actions-tooltip">
            ...
            <div class="tooltip-actions">
              ...
              <span class="tooltip-action">팔로우</span>
              <span class="tooltip-action">음소거</span>
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? '시작 중...' : '보고서 생성 시작' }}
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'QUOTE_POST'">
                  ...
                  <div v-if="action.action_args?.original_content" class="quoted-block">
                    <div class="quote-header">
                      ...
                      <span class="quote-label">@{{ action.action_args.original_author_name || '사용자' }}</span>
                    </div>
                ...
                <template v-if="action.action_type === 'REPOST'">
                  <div class="repost-info">
                    ...
                    <span class="repost-label">@{{ action.action_args?.original_author_name || '사용자' }}의 게시물을 리포스트함</span>
                  </div>
                ...
                <template v-if="action.action_type === 'LIKE_POST'">
                  <div class="like-info">
                    ...
                    <span class="like-label">@{{ action.action_args?.post_author_name || '사용자' }}의 게시물에 좋아요</span>
                  </div>
                ...
                <template v-if="action.action_type === 'CREATE_COMMENT'">
                  ...
                  <div v-if="action.action_args?.post_id" class="comment-context">
                    ...
                    <span>게시물 #{{ action.action_args.post_id }}에 대한 답글</span>
                  </div>
                </template>
                ...
                <template v-if="action.action_type === 'FOLLOW'">
                  <div class="follow-info">
                    ...
                    <span class="follow-label">@{{ action.action_args?.target_user || action.action_args?.user_id || '사용자' }}를 팔로우함</span>
                  </div>
                </template>
                ...
                <template v-if="action.action_type === 'UPVOTE_POST' || action.action_type === 'DOWNVOTE_POST'">
                  <div class="vote-info">
                    ...
                    <span class="vote-label">게시물에 {{ action.action_type === 'UPVOTE_POST' ? '추천' : '비추천' }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'DO_NOTHING'">
                  <div class="idle-info">
                    ...
                    <span class="idle-label">행동 건너뜀</span>
                  </div>
                </template>
    ...
    <div class="system-logs">
      <div class="log-header">
        <span class="log-title">시뮬레이션 모니터</span>
        <span class="log-id">{{ simulationId || '시뮬레이션 없음' }}</span>
      </div>
...
const formatElapsedTime = (currentRound) => {
  if (!currentRound || currentRound <= 0) return '0시간 0분'
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.force_restarted) {
        addLog('✓ 이전 시뮬레이션 로그를 정리하고 시뮬레이션을 재시작했습니다')
      }
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.twitter_current_round > prevTwitterRound.value) {
        addLog(`[정보 광장] R${data.twitter_current_round}/${data.total_rounds} | T:${data.twitter_simulated_hours || 0}h | A:${data.twitter_actions_count}`)
        prevTwitterRound.value = data.twitter_current_round
      }

      if (data.reddit_current_round > prevRedditRound.value) {
        addLog(`[주제 커뮤니티] R${data.reddit_current_round}/${data.total_rounds} | T:${data.reddit_simulated_hours || 0}h | A:${data.reddit_actions_count}`)
...
const formatActionTime = (timestamp) => {
  if (!timestamp) return ''
  try {
    return new Date(timestamp).toLocaleTimeString('ko-KR', { hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })
  } catch {
    return ''
  }
}
